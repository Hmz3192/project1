...
<div class="header">
    <div class="headerTop">
        <ul class="headerUl1 fr">
            <li>Hi&nbsp;,&nbsp;欢迎进入拍库!</li>
            <li><a  id="denglu"  href="${pageContext.request.contextPath}/toLogin"> &nbsp;登录</a>
                <a id="yonghu"   href="#"> &nbsp;用户名</a>
            </li>
            <li><a id="zhuce"  href="${pageContext.request.contextPath}/toLogin" >注册</a>
                <a id="tuichu"  href="javascript:;" >退出</a>
            </li>
            <li class="headerLi1">
                <a href="javascript:;">
                    <i class="ul1Tel"></i>&nbsp;联系客服&nbsp;
...
<div class="index2Search">
    <div class="index2SearchDiv rel">
        <a href="javascript:"><img src="${pageContext.request.contextPath}/static/picture/logopecoo.png"  class="fl header_logo" style="width:128px;height:26px;"/></a>
        <p>
...
<div class="indexToday div">
    ...
    <div class="toadyDiv clear">
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=0" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/1ff1f083a7eb40f1ad0466bacee9b6a3.gif" title="ANTIQUE HUANGHUALI OPEN SHELF DOUBLE DOOR CABINET"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=0" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/2f9c8e70a13d40579e47e7ae3c4d06fc.gif" title="PAIR OF CARVED HUANGHUALI ROSE CHAIRS, MEIGUI YI"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=0" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/b14e23d7e70b41569953060516dde19f.gif" title="QING CHINESE SILK EKAVIRA VAJRABHAIRAVA TANGKA"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=0" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/bccf2472233446e3a03b6bde60f7c833.gif" title="ANTIQUE LACQUERED TALL CHEST IN DRAGON MOTIF"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=0" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/6704e17f0f3a49379fb92a4a93eb22cc.gif" title="FAMILLE ROSE FLORAL MOTIF PORCELAIN TEAPOT"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=0" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/0d445add3a7a4d26a06b3ee3062ec2ee.gif" title="FRAMED 19TH C. CHINESE EMBROIDERY DRAGON SILK PANEL"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=0" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/93748450e7f9414eb6e467f77fdb09ae.gif" title="PAIR ZITAN DOUBLE DOOR &amp; DRAWERS CABINETS"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=0" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/b143d0c9a7db4ec2b528663d20e2b7da.gif" title="A Mongolian silver casket."/>
                </dt>
                <dd>
    ...
    <div class="auctionAllDiv">
        <div class="auctionDiv clearfix">
            ...
            <dl>
                ...
                <dd class="auctionDivDd2">
                    <a href="${pageContext.request.contextPath}/toList?kind=1" target="_blank">
                        <p class="auctionName">名&nbsp;&nbsp;&nbsp; 称&nbsp;&nbsp; ：<span>AFRICAN-AMERICAN FINE ART</span></p>
            ...
            <dl>
                ...
                <dd class="auctionDivDd2">
                    <a href="${pageContext.request.contextPath}/toList?kind=1" target="_blank">
                        <p class="auctionName">名&nbsp;&nbsp;&nbsp; 称&nbsp;&nbsp; ：<span>RIOPELLE,ZUNIGA,ALFEIRI,TOBEY,PICASSO,MURANO,JEWELRY,COINS</span></p>
            ...
            <dl>
                ...
                <dd class="auctionDivDd2">
                    <a href="${pageContext.request.contextPath}/toList?kind=1" target="_blank">
                        <p class="auctionName">名&nbsp;&nbsp;&nbsp; 称&nbsp;&nbsp; ：<span>Russian, American & European paintings XIX-XX</span></p>
...
<div class="indexToday div">
    ...
    <div class="artDiv clearfix">
        ...
        <div class="artRight" id="artRight">
            <a href="${pageContext.request.contextPath}/toList?kind=2" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/23cab9c78cf1451e8a9f048bd248d3c5.gif" /></span>
                <p>5-piece Cabinet vases, Qianlong</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=2" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/8e76ea57b8c34e1eb0f5d3fe7d62bf3c.gif" /></span>
                <p>Chinese Beijing Carpet,</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=2" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/ae7c4d2031314c328f65c78c6b137f31.gif" /></span>
                <p>Chinese Beijing Carpet,</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=2" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/dc3b8b8b639c4b77979f7e67e9430a22.gif" /></span>
                <p>pair of 19th c. Chinese rose medallion porcelain vases</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=2" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/799649552276418a9562091f612f7486.gif" /></span>
                <p>ELEVEN PIECES OF BLUE AND WHITE CANTON PORCELAIN</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=2" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/508226f0ee1f49a78b1b9d4e79c9144a.gif" /></span>
                <p>plate Kang Xi</p>
            </a>
        </div>
    </div>
...
<div class="indexToday div clearfix">
    ...
    <div class="artDiv clearfix">
        ...
        <div class="artRight" id="watchRight">
            <a href="${pageContext.request.contextPath}/toList?kind=3" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/cc6022aa6c6e44bda2e5455d438e1cd6.gif" /></span>
                <p>Rolex 18K Yellow Gold Day-Date Quick Set Men's Ref. 18038 Serial 7098xxx</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=3" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/739957694d724a8b87f4c4e5d12a0e03.gif" /></span>
                <p>Rolex Stainless Steel Black Submariner Men's Reference 16800 Case Serial 9317xxx</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=3" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/f53340845fb44e15bd14cbcab620b292.gif" /></span>
                <p>Bvlgari 18k Rose Gold Strap Watch Ladies Reference L1556 Case Number AA 39 G</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=3" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/bb4d825ca41347d392bfc226411d7506.gif" /></span>
                <p>Rolex Men's 18K Yellow President, QuickSet, Diamond Dial &amp; Diamond Bezel - REF-1232N7F</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=3" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/95e4aaaec2864a0b962009b92a28ee27.gif" /></span>
                <p>Rolex Ladies Two Tone 14K Gold/SS, Diam Dial &amp; Diam/Emerald Bezel, Saph Crystal - REF-368A7N</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=3" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/b8a057eea32d47188f3ecdae3133e1f0.gif" /></span>
    ...
    <div class="watchLogo clearfix" id="watchLogo">
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=3"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/798f68ed7b6f4f7aa552863ea457291a.gif"  width="180" height="90" alt="百达翡丽" />
                </dt>
                <dd>
                    <div>
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=3"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/e6bc79d473d7449492d9c8af90f4b8a0.gif"  width="180" height="90" alt="劳力士" />
                </dt>
                <dd>
                    <div>
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=3"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/3170b9c27b10425ca2c2bcc23f91bde8.gif"  width="180" height="90" alt="欧米茄" />
                </dt>
                <dd>
                    <div>
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=3"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/1ed42255db8c49dfacc1aa3077a4da59.gif"  width="180" height="90" alt="百年灵" />
                </dt>
                <dd>
                    <div>
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=3"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/6631118d7d4846df9b2d35c572f72e2e.gif"  width="180" height="90" alt="卡地亚" />
                </dt>
                <dd>
                    <div>
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=3"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/7b706f5c5f124ec492596fa97df5ebe1.gif"  width="180" height="90" alt="积家" />
                </dt>
                <dd>
                    <div>
...
<div class="indexToday div clearfix">
    ...
    <div class="artDiv clearfix">
        ...
        <div class="artRight" id="jewelRight">
            <a href="${pageContext.request.contextPath}/toList?kind=4" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/d9f54603ccd84483b3aa0aedf66bf4da.gif" /></span>
                <p>Rosette ring white gold, approx. 0.7 ct. Diamond and emerald - 14 kt.</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=4" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/36f3efc097ab4b4294a906f61ca3d7d7.gif" /></span>
                <p>Entourage ring yellow gold, 2.20 ct. Diamond - 18 kt.</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=4" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/b455122773c5488cb2129bf7230800c9.gif" /></span>
                <p>Antique ring bicolor gold, diamond - 14 kt.</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=4" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/3cfe1079174f41e496b34c11c835a691.gif" /></span>
                <p>18K White Gold Round Brilliant &amp; Sapphire Diamond Uni-Sex Ring.</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=4" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/bd220849bff64878bdc1d51717316539.gif" /></span>
                <p>Beautiful Colombian Emerald &amp; Diamond Ring.</p>
            </a>
            <a href="${pageContext.request.contextPath}/toList?kind=4" target="_blank">
                <span><img src="${pageContext.request.contextPath}/static/picture/6de92f2eb23e44ef86bce0a5bf4b0cbe.gif" /></span>
    ...
    <div class="watchLogo clearfix" id="jewelLogo">
        <a href="${pageContext.request.contextPath}/toList?kind=4"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/a4fc0f05f476439695ce5a63d05518e4.gif"  width="180" height="90" alt="宝格丽" />
                </dt>
                <dd>
                    <div>
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=4"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/fd7bfb9e738e4cf797ab76b02f045a3b.gif"  width="180" height="90" alt="蒂芙尼" />
                </dt>
                <dd>
                    <div>
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=4"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/6e1774a3fd1247deb69b19443c848855.gif"  width="180" height="90" alt="梵克雅宝" />
                </dt>
                <dd>
                    <div>
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=4"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/59f027a2fc854fb09ae3e77538894581.gif"  width="180" height="90" alt="香奈儿" />
                </dt>
                <dd>
                    <div>
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=4"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/ac4fa3e1441647229558c10d17ef0b84.gif"  width="180" height="90" alt="戒指" />
                </dt>
                <dd>
                    <div>
        ...
        <a href="${pageContext.request.contextPath}/toList?kind=4"  target="_blank">
            <dl>
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/c700040194014e24a96d11a84cf2a0ce.gif"  width="180" height="90" alt="耳环" />
                </dt>
                <dd>
                    <div>
...
<div class="indexToday div">
    ...
    <div class="toadyDiv clear" id="lightDiv">
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=5" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/2e621f1392db4e0186936d461ab74d44.gif" title="14K Topaz, Diamond &amp; Pearl Pendant"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=5" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/b3aa290de9e744d4b49fffcb68a58f6a.gif" title="Tiffany &amp; Co&dot Round Lock Charm"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=5" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/934cc025c4ef45f5b5ae35ed06aca99a.gif" title="Nina Ricci Textured Clip-On Earrings"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=5" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/c1d3845265f74aacb55dd7501a0694b6.gif" title="14K Sapphire &amp; Diamond Ring"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=5" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/535700fed9d049c0a752a4d41c36d851.gif" title="Judith Ripka Tanzanite &amp; Diamond Pendant"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind=5" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/e2aa54bd394e42bc9a575b779b77926b.gif" title="Judith Ripka 18K Blue Quartz &amp; Diamond Kick Cuff"/>
                </dt>
                <dd>
        ...
        <dl>
            <a href="${pageContext.request.contextPath}/toList?kind= 5" target="_blank">
                <dt>
                    <img src="${pageContext.request.contextPath}/static/picture/50a8a1f801eb44b49943cd2fdb6b2f1b.gif" title="Judith Ripka 18K Diamond Heart Pendant"/>
                </dt>
                <dd>
