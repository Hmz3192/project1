		...
		//alert(urlLoction);
	 	$.ajax({
		    ...
		    error : function(result){
                ...
                storage.setItem(isCertificated, result.isCertificated);
                storage.setItem(isBindCard, result.isBindCard);
                storage.setItem(idCard, result.idCard);
               	storage.setItem(realName, result.realName);
            },
			success : function(data) {
		       if(data.code == "0000"){
                   ...
                   storage.setItem(isCertificated, data.isCertificated);
               		storage.setItem(isBindCard, data.isBindCard);
