...
var isBindCard = storage.getItem("isBindCard");
var isCertificated = storage.getItem("isCertificated");
...
function logout(){
	var storage = window.localStorage;
	 ...
	 delete storage.mobile;
	 delete storage.isManager;
	 delete storage.isChannel;
	 delete storage.isCertificated;
	 delete storage.isBindCard;
	 delete storage.idCard;
	 delete storage.realName;
...
//防重复提交获得Token
function preventQuerySaveToken() {
    $.ajax({
